        ...
        ['R', 'G', 'B'].forEach(color => {
            ...
            for (let i = 0; i < size; i++) {
                ...
                for (let j = 0; j < size; j++) {
                    ...
                    input.max = "255";
                    input.value = "0";
                    input.className = `rgb-input ${color.toLowerCase()}-matrix`;
        ...
        ['Y', 'U', 'V'].forEach(component => {
            ...
            for (let i = 0; i < matrixSize; i++) {
                ...
                for (let j = 0; j < matrixSize; j++) {
                    let r = parseInt(rValues[index].value);
                    let g = parseInt(gValues[index].value);
                    let b = parseInt(bValues[index].value);
